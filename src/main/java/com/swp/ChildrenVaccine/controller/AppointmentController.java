...
public class AppointmentController {
    ...
    public ResponseEntity<List<AppointmentDTO>> getAppointmentsByPhoneNumber(@PathVariable String phoneNumber) {
        List<AppointmentDTO> appointments = appointmentService.getAppointmentsByPhoneNumber(phoneNumber);
        if (appointments.isEmpty()) {
            return ResponseEntity.noContent().build();
        }
        return ResponseEntity.ok(appointments);
