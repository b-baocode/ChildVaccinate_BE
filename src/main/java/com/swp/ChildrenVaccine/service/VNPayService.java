...
public class VNPayService {
    ...
    private BigDecimal calculateAmount(Appointment appointment) {
        if (appointment.getVaccineId() != null) {
            Vaccine vaccine = vaccineRepository.findByVaccineId(appointment.getVaccineId().getVaccineId())
                    .orElseThrow(() -> new RuntimeException("Vaccine not found"));
            return vaccine.getPrice();
        } else if (appointment.getPackageId() != null) {
            VacinePackage vacinePackage = vacinePackageRepository.findByPackageId(appointment.getPackageId().getPackageId())
